    ...
    return (
        <div className="docsPages">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TiHe.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to TiHe, accessible from <a href={data.website} rel="external nofollow noopener" target="_blank">{data.website}</a></p>
                </li>
                <li>
